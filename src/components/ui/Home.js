                ...
                <div className='productListContainer'>
                    {
                        (
                            products.map(function (product) {
                                return <ProductView key={product.productId} url={product.imageUrl} name={product.name} productId={product.productId} brandName={product.brandName} price={product.price} ratings={product.productRating }> </ProductView>
                            }))
                    }
                </div>
            }
